...
module.exports = function () {
    ...
    function checkWorkSpaceBasedOnSid(existingWorkspaceSid) {

        this.client.taskrouter.v1.workspaces(existingWorkspaceSid)
            .fetch()
            .then(workspace => console.log(JSON.stringify(workspace)));
    }
    async function initClient(existingWorkspaceSid) {
    ...
    function findByFriendlyName(friendlyName) {
        ...
        return client.list()
            .then(function (data) {
                console.log(find(data, { friendlyName: friendlyName }));
    ...
    function createWorkspace(workSpaceName) {
        return this.client.create({
            friendlyName: workSpaceName || WORKSPACE_NAME,
    ...
    return {
        ...
        setup: setup,
        checkWorkSpaceBasedOnSid: checkWorkSpaceBasedOnSid
    };
};
